...
class ClientDrawerMenu extends StatefulWidget {
  const ClientDrawerMenu({Key? key}) : super(key: key);

  @override
  State<ClientDrawerMenu> createState() => _ClientDrawerMenuState();
}

class _ClientDrawerMenuState extends State<ClientDrawerMenu> {
  String name = "";
  String email = "";
