...
class FranchiseGoogleMap extends StatefulWidget {
  const FranchiseGoogleMap({super.key});

  createState() => _FranchiseGoogleMapState();
}
...
class _FranchiseGoogleMapState extends State<FranchiseGoogleMap> {
