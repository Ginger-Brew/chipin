...
class RegisterDetailUnderPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _RegisterDetailUnderPageState();
}

class _RegisterDetailUnderPageState extends State<RegisterDetailUnderPage> {
  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
        create: (_) => RegisterModel(),
        child: Scaffold(
          appBar: BaseAppBar(title: 'under'),
          body: Column(
            children: [
