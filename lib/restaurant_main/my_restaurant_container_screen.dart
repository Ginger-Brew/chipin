...
class MyRestaurantContainerScreen extends StatefulWidget {
  final String title;
  ...
  const MyRestaurantContainerScreen({
    Key? key,
    required this.title,
  ...
  // final Set<MyRestaurantContainerScreenState> _saved = new Set<MyRestaurantContainerScreenState>();
  @override
  MyRestaurantContainerScreenState createState() => MyRestaurantContainerScreenState(
    ownerId: ownerId,
...
class MyRestaurantContainerScreenState extends State<MyRestaurantContainerScreen>
  ...
  MyRestaurantContainerScreenState({
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: RestaurantAppBar(title: "가게정보"),
        endDrawer: const RestaurantDrawerMenu(),
        body: SizedBox(
